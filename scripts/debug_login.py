...
Usage: Run this script to verify that the login flow works correctly.
       This is useful when testing account authentication, age verification,
       and troubleshooting login-related issues.

When to use:
- Testing login after modifying login.py
- Debugging authentication failures
- Verifying age verification is working
- Checking that cookies persist correctly

Requirements:
- .env.local with valid BNB_EMAIL and BNB_PASSWORD
